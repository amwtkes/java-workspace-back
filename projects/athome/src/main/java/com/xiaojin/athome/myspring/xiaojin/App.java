package com.xiaojin.athome.myspring.xiaojin;

import com.xiaojin.athome.myspring.factorybean.MyObjectConfiguration;
import com.xiaojin.athome.myspring.objects.Pet;
...
public class App {
    public static void main(String[] args) {
        /*
          可以加上classpath:/
         */
        ApplicationContext context = new ClassPathXmlApplicationContext("classpath:myspring/cat-bean.xml");
